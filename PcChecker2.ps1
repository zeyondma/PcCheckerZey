...
Find-RarAndExeFiles
Find-SusFiles
Log-PrefetchFiles  # Call the new function to log prefetch files
Log-BrowserFolders  # Call the function to log browser folders
...
# Code for completion message unchanged...
 Log-BrowserFolders
